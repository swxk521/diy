...
t = a:section(TypedSection, "user", "", translate("“放行”开始后才会进行时长控制；任一时长留空或填0则禁用时长控制（即仅为时间控制）；放行时间都留空、或相等、或都填00:00则全天时长控制。"))
...
o = t:option(MultiValue, "daysofweek", translate("星期(至少选一天，某天不选则该天不允许放行)"))
o.optional = false
o.rmempty = false
